...
class Departamento():
    ...
    def __init__(self, nombre_depto, d_depto):
        ...
        Se encarga de inicializar los atributos correspondientes de la clase departamento.
    ...
    def aniadir_empleado(self,empleado,):
        ...
        Se encarga de introducir un objeto de tipo empleado al departamento que invoca el metodo.

        :param empleado: Objeto de tipo empleado.
        :type empleado: Empleado.
        :raise empleado: Puede lanzar excepcion si el empleado no es correcto.
        """
    ...
    def get_salario_total(self):
        ...
        Este metodo se encarga de calcular el salario total de todos los empleados para ello recorrera
        todos los empleados y sumara su atributo salario, devolvera una variable con la suma
    ...
    def get_nombre_depto(self):
        ...
        Este metodo devolvera el atributo nombre_depto de la instancia departamento queinvoca el metodo.
    ...
    def get_salario_total_mensual(self):
        ...
        Este metod sera el encargado de sumar los salario mensuales de la lista de empleados.
